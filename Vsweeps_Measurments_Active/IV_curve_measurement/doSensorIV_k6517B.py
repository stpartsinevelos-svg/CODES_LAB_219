...
if __name__ == "__main__":
    ...
    fIlim = 15E-6          # Λογισμικό όριο ρεύματος (A) - αν ξεπεραστεί, το script σταματάει τη μέτρηση
    I_compliance = 1E-4    # Compliance ρεύματος (A) - ΠΡΟΣΟΧΗ: δεν εφαρμόζεται ακόμα εδώ, το psu.setMaxCurrent() για k_6517B είναι σπασμένο στο power_supply.py (task #13)
    dataPath = "DATA/"
       ...
       # psu.setAutoRange(target)
        ...
        for voltage in voltages:
            ...
            for _ in range(N):
                ...
                time.sleep(0.2)#0.7 2
                current, overCurrent, _ = psu.getCurrent(target)
    ...
    # arr = np.array(current_values)
    # plt.plot(arr[:, 0], arr[:, 1]*1e9)   # first two columns
